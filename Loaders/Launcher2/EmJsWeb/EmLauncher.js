...
var wasmBinaryFile = 'EmLauncher.wasm';
...
var ASM_CONSTS = {
  15324: function() {var text_inp = document.getElementById("tid").value; document.getElementById('ifrm').contentWindow.launchWasmTool(text_inp);}
};
