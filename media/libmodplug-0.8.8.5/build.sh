...
cd libvorbis-1.3.5
EMMAKEN_JUST_CONFIGURE=1 emconfigure ./configure --prefix=$WORKSPACE --disable-shared --enable-static CXXFLAGS="-I../../../include -I../../include -I../include" CFLAGS="-I../../../include -I../include -I../../include" LDFLAGS="-L../../lib64"
make install
cd ..
fi
