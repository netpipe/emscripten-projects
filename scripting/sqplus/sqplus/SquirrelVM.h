...
public:
    ...
    static void Shutdown();  // Do final close on VM. Note: This may be inconsistent with shared ownership using external references!
    ...
    static SquirrelObject& GetRetRef(){ return _ret_ref; } 
...
private:
    ...
    static SquirrelObject  _ret_ref; 
};
