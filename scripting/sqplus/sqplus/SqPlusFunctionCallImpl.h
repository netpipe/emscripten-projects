...
SQINLINE bool	Match(TypeWrapper<bool>,HSQUIRRELVM v,int idx)           { return (sq_gettype(v,idx) & SQOBJECT_CANBEFALSE)!=0; } 
...
SQINLINE bool	Match(TypeWrapper<short>,HSQUIRRELVM v,int idx)          { return (sq_gettype(v,idx) & SQOBJECT_NUMERIC)!=0; }
SQINLINE bool	Match(TypeWrapper<unsigned short>,HSQUIRRELVM v,int idx) { return (sq_gettype(v,idx) & SQOBJECT_NUMERIC)!=0; }
SQINLINE bool	Match(TypeWrapper<int>,HSQUIRRELVM v,int idx)            { return (sq_gettype(v,idx) & SQOBJECT_NUMERIC)!=0; }
SQINLINE bool	Match(TypeWrapper<unsigned int>,HSQUIRRELVM v,int idx)   { return (sq_gettype(v,idx) & SQOBJECT_NUMERIC)!=0; }
SQINLINE bool	Match(TypeWrapper<long>,HSQUIRRELVM v,int idx)           { return (sq_gettype(v,idx) & SQOBJECT_NUMERIC)!=0; }
SQINLINE bool	Match(TypeWrapper<unsigned long>,HSQUIRRELVM v,int idx)  { return (sq_gettype(v,idx) & SQOBJECT_NUMERIC)!=0; }
SQINLINE bool	Match(TypeWrapper<float>,HSQUIRRELVM v,int idx)          { return (sq_gettype(v,idx) & SQOBJECT_NUMERIC)!=0; }
SQINLINE bool	Match(TypeWrapper<double>,HSQUIRRELVM v,int idx)         { return (sq_gettype(v,idx) & SQOBJECT_NUMERIC)!=0; }
...
SQINLINE bool           Get(TypeWrapper<bool>,HSQUIRRELVM v,int idx)            { SQBool b; sq_tobool(v,idx,&b); return b != 0; }
...
SQINLINE float          Get(TypeWrapper<float>,HSQUIRRELVM v,int idx)           { SQFloat f; SQPLUS_CHECK_GET(sq_getfloat(v,idx,&f)); return static_cast<float>(f); }
SQINLINE double         Get(TypeWrapper<double>,HSQUIRRELVM v,int idx)          { SQFloat f; SQPLUS_CHECK_GET(sq_getfloat(v,idx,&f)); return static_cast<double>(f); }
