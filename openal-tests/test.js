...
Module['FS_createPath']('/', 'media', true, true);
 ...
 loadPackage({"files": [{"start": 0, "audio": 1, "end": 9638, "filename": "/media/bling.ogg"}, {"start": 9638, "audio": 1, "end": 73188, "filename": "/media/bling.wav"}, {"start": 73188, "audio": 0, "end": 73188, "filename": "/media/new file"}], "remote_package_size": 73188, "package_uuid": "36fcb1a2-5b21-4757-9e4e-ec4b38bece56"});
...
var asmGlobalArg = {};
var asmLibraryArg = { "__assert_fail": ___assert_fail, "__cxa_uncaught_exceptions": ___cxa_uncaught_exceptions, "__lock": ___lock, "__syscall221": ___syscall221, "__syscall5": ___syscall5, "__syscall54": ___syscall54, "__unlock": ___unlock, "alBufferData": _alBufferData, "alGenBuffers": _alGenBuffers, "alGenSources": _alGenSources, "alGetBufferi": _alGetBufferi, "alGetListenerf": _alGetListenerf, "alGetSourcei": _alGetSourcei, "alGetString": _alGetString, "alIsSource": _alIsSource, "alListenerf": _alListenerf, "alListenerfv": _alListenerfv, "alSourcePause": _alSourcePause, "alSourcePlay": _alSourcePlay, "alSourceStop": _alSourceStop, "alSourcei": _alSourcei, "alcCreateContext": _alcCreateContext, "alcGetIntegerv": _alcGetIntegerv, "alcGetString": _alcGetString, "alcMakeContextCurrent": _alcMakeContextCurrent, "alcOpenDevice": _alcOpenDevice, "emscripten_async_call": _emscripten_async_call, "emscripten_get_sbrk_ptr": _emscripten_get_sbrk_ptr, "emscripten_memcpy_big": _emscripten_memcpy_big, "emscripten_resize_heap": _emscripten_resize_heap, "fd_close": _fd_close, "fd_read": _fd_read, "fd_seek": _fd_seek, "fd_write": _fd_write, "memory": wasmMemory, "setTempRet0": _setTempRet0, "table": wasmTable };
var asm = createWasm();
...
var real__test_finished = asm["test_finished"];
asm["test_finished"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__test_finished.apply(null, arguments);
};
...
var _test_finished = Module["_test_finished"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["test_finished"].apply(null, arguments)
};
