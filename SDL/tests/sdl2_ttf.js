...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'sdl2_ttf.data';
    var REMOTE_PACKAGE_BASE = 'sdl2_ttf.data';
...
Module['FS_createPath']('/', 'media', true, true);
        ...
        DataRequest.prototype.byteArray = Module['HEAPU8'].subarray(ptr, ptr+byteArray.length);
          ...
          for (var i = 0; i < files.length; ++i) {
            DataRequest.prototype.requests[files[i].filename].onload();
              ...
              Module['removeRunDependency']('datafile_sdl2_ttf.data');

    };
    Module['addRunDependency']('datafile_sdl2_ttf.data');
 ...
 loadPackage({"files": [{"start": 0, "audio": 0, "end": 11755, "filename": "/media/sdl2_ttf.png"}, {"start": 11755, "audio": 0, "end": 16237, "filename": "/media/sdl2_canvas.png"}], "remote_package_size": 16237, "package_uuid": "3948374a-1321-4f75-8226-03c3fc056f43"});
...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 171664,
    DYNAMIC_BASE = 5414544,
    DYNAMICTOP_PTR = 171504;
...
var wasmBinaryFile = 'sdl2_ttf.wasm';
